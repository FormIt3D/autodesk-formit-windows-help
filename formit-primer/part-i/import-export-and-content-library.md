...
_**Consejo:**_ _Para agilizar el proceso, es recomendable utilizar el archivo_ _**Ottoman - Barcelona\_Mies.axm**_ _que acaba de crear como plantilla. Durante el modelado, es posible que desee activar de nuevo las opciones_ _**Rejilla**_ _y_ _**Ejes**_ _de la_ _**paleta Estilos visuales**. Al ajustar solo la posición de la cámara de la_ _**escena de miniatura**_ _para cada mueble, se garantiza la coherencia de las_ _**miniaturas de contenido**_ _entre todos los modelos de contenido._
