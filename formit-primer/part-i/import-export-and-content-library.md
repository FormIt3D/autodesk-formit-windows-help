...
1. **Zaimportuj plik lokalny (Ctrl + I)**, wybierając kolejno opcje **Importuj > Lokalnie** z listy rozwijanej **Plik** na pasku **Menu główne**.
...
**Uwaga:** jeśli masz dostęp do usługi **Autodesk Docs** (wcześniej Autodesk 360), możesz uzyskać dostęp do zapisanych tam plików również za pomocą menu rozwijanego **Biblioteka elementów**.
...
3 — Ustaw kamerę na tryb **Prostopadły (VO)** i **Widok z góry (VT)**, a następnie wyłącz **podłogę głównego budynku**, aby pokazać **obraz rzutu**. Więcej informacji na temat ustawień **widoków** i **warstw** można znaleźć w poprzednich rozdziałach.
