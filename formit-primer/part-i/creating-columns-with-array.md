...
5. Wyłącz opcję **Przyciągaj do siatki (SG)** (jeśli jest włączone). To pomoże w rysowaniu linii szczegółów.
...
2. Kliknij prawym przyciskiem myszy i wybierz **narzędzie Odbij \(MI\)**.
...
5. Nadal nie anulując wyboru 3 nowych słupów, kliknij prawym przyciskiem myszy jeden ze skopiowanych słupów i wybierz opcję **Ustaw jako niepowtarzalne (MU)**. Słupy są teraz skojarzone ze sobą, ale unikatowe względem oryginałów.
