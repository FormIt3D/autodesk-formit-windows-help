...
3. Как и на предыдущем шаге, переместите геометрию еще раз, привязав ее к красной оси (**X**).
...
_**Примечание.**_ _Если при перемещении профиля колонны она выровнялась по крыше, выдавите грань на_ _**17 футов 8 дюймов**_\ _вниз, а не вверх._
...
1. Щелкните колонну, чтобы начать создание **массива**. Переместите указатель вдоль красной оси (**X**).
...
3. Переместите копии вниз по зеленой оси (**Y**) на **23 фута 4 3/8 дюйма**. Нажмите клавишу **Esc**.
