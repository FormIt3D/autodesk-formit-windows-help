...
1. Accédez à la **vue de dessus (VT)**.
...
1 – Accédez à la **vue de dessus (VT)** et définissez de nouveau le mode caméra sur **Orthogonale (VO)**.
...
7 – Pour visualiser l’ensemble du bâtiment, accédez à la **vue 3D (V3)** et définissez-la sur **Perspective (VP)**. Si les calques **Main Building Floor** (Sol du bâtiment principal), **Roof** (Toit), **Lower Terrace** (Terrasse inférieure) et **Column** (Poteau) sont désactivés, activez-les.
...
3. Déplacez les copies vers le bas le long de l’axe vert (**axe Y**) de **23 pi-4 3/8 po**. Appuyez sur la touche **Échap**.
