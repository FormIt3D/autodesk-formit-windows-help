...
_**Anmerkung:**_ _Der Pfosten befindet sich jetzt direkt hinter der Stütze. Deaktivieren Sie den Layer_ _**Column**_, _oder_ _**umkreisen (O)**_ _Sie die Ansicht, um den Pfosten zu visualisieren._
...
3. Nachdem Sie das Profil ausgewählt haben, werden Sie aufgefordert, eine **Fläche (oder Kante) für den Sweeping-Pfad auszuwählen und dann auf Fertig stellen zu klicken**. Wählen Sie die obere Dachfläche aus. FormIt verwendet automatisch die Begrenzungen der ausgewählten Fläche als Sweep-Pfad, und das Sweeping wird um das gesamte Dach erstellt.
