...
_Теперь создайте карниз для дома Фарнсворт с помощью одного из передовых инструментов моделирования FormIt —_ _**Сдвиг**. Подробнее о других расширенных возможностях моделирования можно узнать, прочитав главу_ **2.2.** _**Дополнительные возможности моделирования** в_ ___**части II руководства FormIt Primer**._
...
_**Примечание.**_ _Если не удается выбрать одну из граней, поверните грань с помощью инструмента_ _**Орбита (O)**__, чтобы чуть лучше ее видеть, и повторите попытку. Также для выполнения сдвига можно выбрать все кромки крыши, а не ее верхнюю грань._
