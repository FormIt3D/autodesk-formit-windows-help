...
_**Примечание.**_ _Если не удается выбрать одну из граней, поверните грань с помощью инструмента_ _**Орбита (O)**_ _, чтобы чуть лучше ее видеть, и повторите попытку. Также для выполнения сдвига можно выбрать все кромки крыши, а не ее верхнюю грань._
