...
_Si es la primera vez que utiliza Dynamo en FormIt, es recomendable consultar el capítulo_ _**1.10 -**_ _**Grupo de cálculo con Dynamo**_ _,de la_ _**parte 1**_ _de FormIt Primer. Aunque este capítulo conllevará la edición de gráficos de Dynamo, solo abordaremos realmente elementos de Dynamo en relación con los nodos específicos de FormIt. Si es un nuevo usuario de Dynamo, puede obtener más información en_ [_**Dynamo Primer**_](https://primer.dynamobim.org/01\_Introduction/1-2\_what\_is\_dynamo.html)_**.**_
...
4. Vaya a la ubicación en la que haya descargado el **conjunto de datos del modelo Encode** y seleccione la carpeta **Supporting Files** > **FormIt Primer Graphs**.
...
5. Conecte las dos (2) entradas del nuevo nodo **SendToFormIt.Stairs**, como se muestra en la imagen siguiente.
