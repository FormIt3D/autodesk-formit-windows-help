...
4. Accédez à l’emplacement où vous avez téléchargé le dossier **Encode Model Data Set** (Jeu de données Modèle Encode) et sélectionnez le dossier **Supporting Files** > **FormIt Primer Graphs** (Fichiers de support > Graphiques FormIt Primer).
...
5. Connectez les deux (2) entrées du nouveau nœud **SendToFormIt.Stairs**, comme illustré dans l’image ci-dessous.
...
1. Dans la zone **Modules complémentaires**, développez **FormIt** et double-cliquez sur **SelectFromFormIt**. Deux (2) nouveaux nœuds sont normalement créés au centre de l’écran.
