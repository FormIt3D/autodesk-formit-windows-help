...
2. Desenhe um **Polígono (Y)** com **8** lados e um raio de **30’** e posicione-o no **Plano XY.**
...
3. Use a ferramenta **Inclinar face (TF)** para criar uma transição mais suave entre o nível base e o terreno natural. Agora temos uma plataforma boa na qual construir nossa construção octogonal, com base nos dados reais do terreno.
