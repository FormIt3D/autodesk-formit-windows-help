...
_**Uwaga:**_ _jeśli bieżące zaznaczenie zawiera już geometrię, którą można połączyć, np. dwie (2) lub więcej nakładających się brył, z menu kontekstowego można również uzyskać dostęp do narzędzia_ _**Dołącz geometrię (JG)**_ _, klikając prawym przyciskiem myszy wybraną geometrię._
