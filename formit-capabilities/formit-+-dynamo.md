...
* Al seleccionar la geometría para un nodo [SelectFromFormIt](https://formit.autodesk.com/page/formit-dynamo#dynamo-formit-nodes), resulta útil almacenarla en un grupo de FormIt y seleccionar el grupo en su lugar.
...
* Para utilizar Dynamo en FormIt, necesitará [FormIt para Windows](https://formit.autodesk.com/page/download) v17.0 o posterior.
...
* Si tiene un sistema con una [tarjeta gráfica NVIDIA o AMD](https://www.howtogeek.com/414201/how-to-check-what-graphics-card-gpu-is-in-your-pc/), o tiene varias tarjetas, es posible que deba configurar FormIt y Dynamo para que utilicen una GPU de alta potencia:
  ...
  * Utilice los paneles de control de [NVIDIA](https://nvidia.custhelp.com/app/answers/detail/a\_id/2615/\~/how-do-i-customize-optimus-profiles-and-settings%3F) o [AMD](https://www.amd.com/en/support/kb/faq/dh-017) para configurar las siguientes aplicaciones a fin de que utilicen la tarjeta gráfica correspondiente:
...
¿Necesita ayuda con FormIt + Dynamo? [Informe de ello en los foros](https://forums.autodesk.com/t5/formit-forum/bd-p/142).
