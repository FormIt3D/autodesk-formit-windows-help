...
FormIt 2024 verwendet jetzt die neueste Dynamo-Version 2.17.
...
[FormIt 2022.1](https://formit.autodesk.com/blog/post/introducing-formit-2022-1) bietet die Möglichkeit, [vertraute FormIt-Bemaßungen als Eingaben](https://formit.autodesk.com/page/formit-dynamo#dynamo-input-nodes) zu verwenden, enthält neue [Optionen auf Objektebene](https://formit.autodesk.com/page/formit-dynamo#dynamo-formit-options-nodes) und bietet eine frühe Vorschau auf den [JavaScript-API-Zugriff](https://formit.autodesk.com/page/formit-dynamo#dynamo-js-api-nodes). [Jetzt herunterladen](https://formit.autodesk.com/page/download).
...
[FormIt 2021](https://formit.autodesk.com/blog/post/introducing-formit-2021) fügt den [SelectFromFormIt](https://formit.autodesk.com/page/formit-dynamo#dynamo-formit-nodes)-Block hinzu und ermöglicht immer verbundene Sitzungen, Bearbeitung mehrerer Instanzen und vieles mehr.
...
* Die Gruppe Dynamo funktioniert wie die [Inhaltsbibliothek](https://windows.help.formit.autodesk.com/building-the-farnsworth-house/import-export-and-content-library) und ermöglicht Ihnen, lokale Verzeichnisse mit Dynamo-Dateien zu verknüpfen und zu verwalten.
...
* Durch das Platzieren der Geometrie in FormIt wird eine Kopie des Dynamo-Diagramms in die FormIt-Datei eingebettet.
  * Um Geometrie zu generieren, muss ein [SendToFormIt](https://formit.autodesk.com/page/formit-dynamo#dynamo-formit-nodes)-Block den Ausgabegeometrie-Blöcken im Diagramm zugeordnet werden.
...
* Laden Sie das [Dynamo-Beispieldiagramm hier](https://formit-help.s3.amazonaws.com/Send+Levels+to+Excel.dyn) herunter.
* Verweisen Sie die Dynamo-Palette auf das lokale Verzeichnis, in dem das Dynamo-Diagramm gespeichert wurde.
* Klicken Sie mit der rechten Maustaste auf die Miniaturansicht, und wählen Sie _Eingebettetes Diagramm bearbeiten._
...
Quelldiagramme werden in der Gruppe Dynamo nach dem [Verknüpfen lokaler Verzeichnisse](https://formit.autodesk.com/page/formit-dynamo#dynamo-getting-started) angezeigt. Diese Diagramme werden auf Ihrem Computer gespeichert und können in Dynamo bearbeitet werden, indem Sie auf die Schaltfläche Quelldiagramm bearbeiten klicken.

![](../.gitbook/assets/dynamo\_editsourcegraph.png)

![](../.gitbook/assets/dynamo\_sourcegraphgif.gif)

* [Verknüpfen Sie ein Verzeichnis](https://formit.autodesk.com/page/formit-dynamo#dynamo-getting-started), das Dynamo-Dateien enthält, mit der Gruppe Dynamo, und navigieren Sie dann zu diesem Speicherort in der Gruppe. 
...
[Erfahren Sie mehr über die Einstellungen für Kurven- und Oberflächenfacettierung in FormIt.](https://windows.help.formit.autodesk.com/tool-library/curve-+-surface-faceting)
...
* Bei der Auswahl in FormIt wird der aktive [Auswahlfilter](https://windows.help.formit.autodesk.com/tool-library/select-edge-face-or-object#selection-filtering) angewendet. Wenn Sie beispielsweise FormIt-Scheitelpunkte auswählen möchten, müssen Sie diese Option im Auswahlfilter aktivieren.
...
* Um Dynamo in FormIt verwenden zu können, benötigen Sie [FormIt für Windows](https://formit.autodesk.com/page/download) v17.0 oder höher.
...
* Wenn Sie ein System mit einer [NVIDIA- oder AMD-Grafikkarte](https://www.howtogeek.com/414201/how-to-check-what-graphics-card-gpu-is-in-your-pc/) oder mehreren Karten nutzen, müssen Sie möglicherweise FormIt und Dynamo so einrichten, dass sie die leistungsstarke GPU verwenden:
  ...
  * Verwenden Sie die [NVIDIA](https://nvidia.custhelp.com/app/answers/detail/a\_id/2615/\~/how-do-i-customize-optimus-profiles-and-settings%3F)\- oder [AMD](https://www.amd.com/en/support/kb/faq/dh-017)-Systemsteuerungen, um die folgenden Anwendungen so einzurichten, dass Ihre eigenständige Grafikkarte verwendet wird:
...
Benötigen Sie Hilfe bei FormIt und Dynamo? [Nehmen Sie über die Foren Kontakt mit uns auf](https://forums.autodesk.com/t5/formit-forum/bd-p/142).
