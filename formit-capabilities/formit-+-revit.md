...
## Přehled nových funkcí v aplikacích FormIt a Revit <a href="#revit-what-s-new" id="revit-what-s-new"></a>

### **Vylepšení aplikace FormIt 2023.1** <a href="#formit-20221-improvements" id="formit-20221-improvements"></a>

* Umístění nastavené v aplikaci Revit je nyní synchronizováno s aplikací FormIt při spuštění pomocí tlačítka 3D náčrt.
* Byla vylepšena synchronizace skici DWG při spuštění aplikace FormIt pomocí tlačítka 3D náčrt.
* Volitelná synchronizace kamery mezi aplikacemi FormIt a Revit ve 3D náčrtu nebo při úpravě připojeného objektu aplikace FormIt.

### Výkon propojení ve verzi 2023<a href="#formit-20221-improvements" id="formit-20221-improvements"></a>
...
### **Vylepšení aplikace FormIt 2022.1** <a href="#formit-20221-improvements" id="formit-20221-improvements"></a>
...
### **Nové funkce ve verzi 2022** <a href="#all-new-for-2022" id="all-new-for-2022"></a>
...
### **Vylepšení aplikace Revit 2021.1** <a href="#revit-20211-improvements" id="revit-20211-improvements"></a>
...
## Začínáme s aplikacemi FormIt a Revit<a href="#revit-workflows" id="revit-workflows"></a>

### **Intuitivní 3D kreslení přímo z aplikace Revit** <a href="#intuitive-3d-sketching-directly-from-revit" id="intuitive-3d-sketching-directly-from-revit"></a>
...
![Použití tlačítka Upravit v aplikaci FormIt po výběru objektu aplikace FormIt](../.gitbook/assets/revit-edit-in-formit-workflow.gif)
...
* Tlačítka _**3D náčrt**_ a _**Upravit v aplikaci FormIt**_ a pracovní postup _**Odeslat do aplikace Revit**_ jsou k dispozici pro předplatitele sady Autodesk Architecture Engineering & Construction Collection (AEC Collection) a zákazníkům s určitými typy přístupu. Nejsou k dispozici pro uživatele aplikace Revit LT. [Další informace o sadě AEC Collection najdete zde.](https://www.autodesk.com/collections/architecture-engineering-construction/overview)

### Tlačítko 3D náčrt

![Spusťte novou instanci pomocí tlačítka 3D náčrt a uložte a vytvořte připojení aplikace Revit pomocí tlačítka Odeslat do aplikace FormIt](../.gitbook/assets/revit-3d-sketch-send-to-revit.png)
...
#### Dialog Otevřít aplikaci FormIt zobrazený kliknutím na tlačítko 3D náčrt

* Kliknutím na tlačítko _**3D náčrt**_ spusťte aplikaci FormIt. Zvolte, zda chcete do aplikace FormIt přenést všechny viditelné objekty nebo pouze vybrané objekty. 
  * Přenesení pouze vybraných objektů je vhodné zvolit, pokud je model Revit velký a návrh bude odkazovat pouze na část modelu Revit. 
  * Pomocí ořezového kvádru v aplikaci Revit můžete navíc izolovat vnitřní oblast modelu aplikace Revit, kterou chcete přenést do aplikace FormIt.

![](../.gitbook/assets/revit-objects.png)

#### 3D náčrt a podlaží

* Pokud je vybrána možnost „všechny viditelné objekty aplikace Revit“, všechna viditelná podlaží aplikace Revit se stanou podlažími aplikace FormIt, které lze [zobrazit na paletě Podlaží](../tool-library/levels-and-area.md#creating-and-configuring-levels) nebo [použít na objekty prostřednictvím palety Vlastnosti](../tool-library/levels-and-area.md#applying-levels).
* Pokud je vybrána možnost „vybrané objekty aplikace Revit“, stanou se podlažími aplikace FormIt pouze vybraná podlaží.

#### Po spuštění aplikace FormIt
...
* Na objekty aplikace FormIt můžete použít podlaží z [palety Podlaží](../tool-library/levels-and-area.md#applying-levels).

### Pracovní postup odeslání do aplikace Revit
...
![Sloupec Odeslat do aplikace Revit na paletě Hladiny](../.gitbook/assets/revit-send-to-formit-layers-column.png)
...
![Režim náhledu aplikace Revit](../.gitbook/assets/revit-preview-mode.png)
...
* Společně s geometrií budou do aplikace Revit přeneseny hladiny a materiály aplikace FormIt.
  ...
  * Chcete-li do aplikace Revit odeslat podlaží, je nutné importovat soubor AXM pomocí dialogu Importovat CAD a v dolní části zaškrtnout políčko Importovat podlaží.
...
### **Import a připojení modelů aplikace FormIt: Spolupráce na návrhu mezi aplikacemi FormIt a Revit** <a href="#importing-formit-models-design-collaboration-between-formit-and-revit" id="importing-formit-models-design-collaboration-between-formit-and-revit"></a>
...
![Tlačítko Připojit CAD v aplikaci Revit](../.gitbook/assets/revit-linking.png)
...
* Přenos materiálů aplikace FormIt do aplikace Revit a jejich zobrazení v dialogu materiálů aplikace Revit. Vyfiltrujte v seznamu materiály aplikace FormIt.
...
* Další informace naleznete v [dokumentaci k aplikaci Revit.](https://help.autodesk.com/view/RVT/2023/ENU/?guid=GUID-A5F4B6C1-94CD-4433-A4E2-6B39B4BA8E6D)
...
#### **Převod rodin aplikace Revit** <a href="#converting-revit-families" id="converting-revit-families"></a>
...
#### **Příprava souborů aplikace SketchUp pro aplikaci Revit** <a href="#preparing-sketchup-files-for-revit" id="preparing-sketchup-files-for-revit"></a>

* V aplikaci FormIt pro systém Windows otevřete nebo importujte obsah aplikace SketchUp.
* Volitelně můžete použít [vestavěné diagnostické a opravné nástroje k opravě geometrie](https://formit.autodesk.com/blog/post/using-formit-to-get-sketchup-data-into-revit), aby byla pevnější a lépe vyhovovala následným operacím.
...
## Přechod z doplňku FormIt Converter <a href="#revit-the-add-in" id="revit-the-add-in"></a>
...
### **Nový způsob importu souborů AXM** <a href="#a-new-way-to-import-axm-files" id="a-new-way-to-import-axm-files"></a>

Tlačítko _Importovat soubor FormIt do formátu RVT_ v doplňku je nahrazeno možností importu souborů aplikace FormIt (AXM) pomocí nástroje Importovat CAD na kartě Vložit v aplikaci Revit. 
...
### **Změny rodin aplikace Revit** <a href="#changes-to-revit-families" id="changes-to-revit-families"></a>

Obsah rodin aplikace Revit můžete v aplikaci FormIt nadále používat pomocí tlačítka _Převést soubor RFA do formátu FormIt_ na kartě Doplňky v aplikaci Revit. V tomto pracovním postupu se nic nemění.
...
## Důležité poznámky <a href="#revit-important-notes" id="revit-important-notes"></a>

### **Získání podpory** <a href="#get-support" id="get-support"></a>

Potřebujete nápovědu k aplikacím FormIt a Revit? [Dejte nám vědět na fórech](https://forums.autodesk.com/t5/formit-forum/bd-p/142).

Stažení starého doplňku pro aplikaci Revit\
 (2021 nebo starší) <a href="#revit-download" id="revit-download"></a>
------------------------------------------------------------------
...
[Podívejte se na staré doplňky pro aplikaci Revit ke stažení](https://formit.autodesk.com/page/download#download-revit-add-in)
