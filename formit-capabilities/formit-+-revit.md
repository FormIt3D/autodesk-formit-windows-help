...
## La facilità di FormIt incontra la potenza di Revit <a href="#revit-intro" id="revit-intro"></a>
...
## Novità di FormIt + Revit <a href="#revit-what-s-new" id="revit-what-s-new"></a>

### La potenza del collegamento per la versione 2023 <a href="#formit-20221-improvements" id="formit-20221-improvements"></a>
...
### **Miglioramenti di FormIt 2022.1** <a href="#formit-20221-improvements" id="formit-20221-improvements"></a>
...
### **Tutte le novità della versione 2022** <a href="#all-new-for-2022" id="all-new-for-2022"></a>
...
### **Miglioramenti di Revit 2021.1** <a href="#revit-20211-improvements" id="revit-20211-improvements"></a>
...
## Introduzione a FormIt + Revit <a href="#revit-workflows" id="revit-workflows"></a>

### **Disegni 3D intuitivi direttamente da Revit** <a href="#intuitive-3d-sketching-directly-from-revit" id="intuitive-3d-sketching-directly-from-revit"></a>
...
### **Disegno 3D, Modifica in FormIt e Invia a Revit per l'iterazione di progetto** <a href="#3d-sketch-and-send-to-revit-for-design-iteration" id="3d-sketch-and-send-to-revit-for-design-iteration"></a>
...
![Utilizzo di Modifica in FormIt dopo la selezione di un oggetto di FormIt](../.gitbook/assets/revit-edit-in-formit-workflow.gif)
...
* Il pulsante _**Disegno 3D**_, il pulsante _**Modifica in FormIt**_ e il workflow _**Invia a Revit**_ sono disponibili per gli abbonati alla Architecture, Engineering, & Construction (AEC) Collection Autodesk e per i clienti con tipi di accesso specifici. Non sono disponibili in Revit LT. [Ulteriori informazioni sulla AEC Collection si trovano qui.](https://www.autodesk.it/collections/architecture-engineering-construction/overview)

![Avvio di una nuova istanza con Disegno 3D, quindi salvataggio e creazione di un collegamento di Revit con Invia a FormIt](../.gitbook/assets/revit-3d-sketch-send-to-revit.png)
...
* Fare clic sul pulsante _**Disegno 3D**_ per avviare FormIt. Scegliere di importare in FormIt tutti gli oggetti visibili o solo gli oggetti selezionati. La scelta di importare solo gli oggetti selezionati è utile se il modello di Revit è di grandi dimensioni e il progetto farà riferimento solo ad una parte del modello di Revit. Inoltre, utilizzare un riquadro di sezione in Revit per isolare un'area interna del modello di Revit da importare in FormIt.

![](../.gitbook/assets/revit-objects.png)

* Se si selezionano i livelli in Revit, questi verranno visualizzati in FormIt. In caso contrario, in FormIt verranno visualizzati tutti i livelli visibili in Revit.
...
* Applicare i livelli agli oggetti di FormIt dalla tavolozza Livelli.
* Utilizzare la _**colonna Invia a Revit**_ nella tavolozza Layer per includere o escludere la geometria da inviare a Revit.

![Colonna Invia a Revit nella tavolozza Layer](../.gitbook/assets/revit-send-to-formit-layers-column.png)
...
![Modalità anteprima di Revit](../.gitbook/assets/revit-preview-mode.png)
...
* Trasferire la geometria di FormIt in Revit utilizzando il pulsante _**Invia a Revit**_ sulla barra degli strumenti di FormIt.
   * Verrà visualizzato un messaggio di richiesta per salvare il file, che collega il modello a Revit.
      * **Nota** È consigliabile salvare il file localmente, poiché il salvataggio in Autodesk Docs interromperà la connessione tra FormIt e Revit. Utilizzare invece [Autodesk Desktop Connector](https://help.autodesk.com/view/CONNECT/ITA/) per condividere i modelli nel cloud.
...
* I livelli, i layer e i materiali di FormIt verranno trasferiti in Revit insieme alla geometria.
...
* Quando si avvia Revit 2023.0 o una versione successiva e si seleziona un oggetto di FormIt, è possibile utilizzare il pulsante _**Modifica in FormIt**_ per avviare il modello in FormIt.
...
### **Importazione e collegamento di modelli di FormIt: Collaborazione progettuale tra FormIt e Revit** <a href="#importing-formit-models-design-collaboration-between-formit-and-revit" id="importing-formit-models-design-collaboration-between-formit-and-revit"></a>
...
![Collega CAD in Revit](../.gitbook/assets/revit-linking.png)
...
* Ulteriori informazioni sono disponibili nella [documentazione di Revit.](https://help.autodesk.com/view/RVT/2023/ITA/?guid=GUID-A5F4B6C1-94CD-4433-A4E2-6B39B4BA8E6D)
...
#### **Conversione delle famiglie di Revit** <a href="#converting-revit-families" id="converting-revit-families"></a>
...
* Questo è un ottimo modo per riutilizzare tutto il contenuto di Revit di cui già si dispone. È sufficiente convertire il contenuto in FormIt e puntare la libreria di contenuti di FormIt alla cartella contenente i file convertiti. Quindi, dalla tavolozza Libreria di contenuti, fare clic su un'anteprima e posizionarla nel modello.

![](../.gitbook/assets/content-library.jpg)

#### **Preparazione dei file di SketchUp per Revit** <a href="#preparing-sketchup-files-for-revit" id="preparing-sketchup-files-for-revit"></a>
...
## Passaggio dal modulo aggiuntivo Convertitore FormIt <a href="#revit-the-add-in" id="revit-the-add-in"></a>
...
### **Un nuovo modo per importare i file AXM** <a href="#a-new-way-to-import-axm-files" id="a-new-way-to-import-axm-files"></a>
...
### **Modifiche apportate alle famiglie di Revit** <a href="#changes-to-revit-families" id="changes-to-revit-families"></a>
...
(2021 o versione precedente) <a href="#revit-download" id="revit-download"></a>
------------------------------------------------------------------
...
[Vedere i download precedenti del modulo aggiuntivo per Revit](https://formit.autodesk.com/page/download#download-revit-add-in).
