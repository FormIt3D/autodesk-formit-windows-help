...
## Benutzerfreundlichkeit von FormIt kombiniert mit der Leistung von Revit <a href="#revit-intro" id="revit-intro"></a>
...
## Neue Funktionen in FormIt und Revit <a href="#revit-what-s-new" id="revit-what-s-new"></a>

### Vorteile der Verknüpfung für Version 2023 <a href="#formit-20221-improvements" id="formit-20221-improvements"></a>
...
### **Alle neuen Funktionen in Version 2022** <a href="#all-new-for-2022" id="all-new-for-2022"></a>
...
### **Verbesserungen in Revit 2021.1** <a href="#revit-20211-improvements" id="revit-20211-improvements"></a>
...
## Erste Schritte mit FormIt und Revit <a href="#revit-workflows" id="revit-workflows"></a>

### **Intuitives 3D-Skizzieren direkt in Revit** <a href="#intuitive-3d-sketching-directly-from-revit" id="intuitive-3d-sketching-directly-from-revit"></a>
...
### **3D-Skizze, In FormIt bearbeiten und An Revit senden für Entwurfsiterationen** <a href="#3d-sketch-and-send-to-revit-for-design-iteration" id="3d-sketch-and-send-to-revit-for-design-iteration"></a>
...
![Verwenden von In FormIt bearbeiten nach Auswahl eines FormIt-Objekts](../.gitbook/assets/revit-edit-in-formit-workflow.gif)
...
* Die Schaltflächen _**3D-Skizze**_ und _**In FormIt bearbeiten**_ sowie der Arbeitsablauf _**An Revit senden**_ stehen Abonnenten der Autodesk Architecture, Engineering & Construction (AEC) Collection und Kunden mit bestimmten Zugriffstypen zur Verfügung. Sie sind in Revit LT nicht verfügbar. [Hier erfahren Sie mehr über die AEC Collection.](https://www.autodesk.de/collections/architecture-engineering-construction/overview)

![Starten Sie eine neue Instanz mit einer 3D-Skizze, und speichern und erstellen Sie mithilfe von An FormIt senden eine Revit-Verknüpfung.](../.gitbook/assets/revit-3d-sketch-send-to-revit.png)
...
* Klicken Sie auf die Schaltfläche _**3D-Skizze**_, um FormIt zu starten. Wählen Sie diese Option, um alle sichtbaren Objekte oder nur ausgewählte Objekte in FormIt zu importieren. Die Auswahl, nur ausgewählte Objekte einzubeziehen, ist hilfreich, wenn das Revit-Modell groß ist und die Konstruktion nur einen Teil des Revit-Modells referenziert. Außerdem können Sie mithilfe eines Schnittbereichs in Revit einen Innenbereich des Revit-Modells isolieren, um ihn in FormIt zu importieren.

![](../.gitbook/assets/revit-objects.png)

* Wenn Sie Ebenen in Revit auswählen, werden diese in FormIt angezeigt. Andernfalls werden alle sichtbaren Ebenen in Revit an FormIt übergeben.
...
* Wenden Sie Ebenen über die Palette Ebenen auf FormIt-Objekte an.
* Verwenden Sie die _**Spalte An Revit senden**_ in der Palette Layer, um Geometrie einzuschließen, die an Revit übertragen werden soll, bzw. diese auszuschließen.

![Spalte An Revit senden in der Palette Layer](../.gitbook/assets/revit-send-to-formit-layers-column.png)
...
![Revit-Vorschaumodus](../.gitbook/assets/revit-preview-mode.png)
...
* Die Ebenen, Layer und Materialien aus FormIt werden zusammen mit der Geometrie an Revit übertragen.
...
* Wenn Sie Revit 2023.0 oder eine neuere Version starten und ein FormIt-Objekt auswählen, können Sie mithilfe der Schaltfläche _**In FormIt bearbeiten**_ das Modell in FormIt starten.
...
### **Importieren und Verknüpfen von FormIt-Modellen: Entwurfszusammenarbeit zwischen FormIt und Revit** <a href="#importing-formit-models-design-collaboration-between-formit-and-revit" id="importing-formit-models-design-collaboration-between-formit-and-revit"></a>
...
![CAD-Verknüpfungen in Revit](../.gitbook/assets/revit-linking.png)
...
#### **Konvertieren von Revit-Familien** <a href="#converting-revit-families" id="converting-revit-families"></a>
...
#### **Vorbereiten von SketchUp-Dateien für Revit** <a href="#preparing-sketchup-files-for-revit" id="preparing-sketchup-files-for-revit"></a>

* Verwenden Sie FormIt for Windows zum Öffnen oder Importieren von SketchUp-Inhalten.
* Verwenden Sie optional die [integrierten Diagnose- und Reparaturwerkzeuge, um Geometrie zu reparieren](https://formit.autodesk.com/blog/post/using-formit-to-get-sketchup-data-into-revit), sodass sie besser für nachfolgende Operationen geeignet ist.
...
## Umstellung des Zusatzmoduls FormIt-Konverter <a href="#revit-the-add-in" id="revit-the-add-in"></a>
...
### **Neue Methode zum Importieren von AXM-Dateien** <a href="#a-new-way-to-import-axm-files" id="a-new-way-to-import-axm-files"></a>
...
### **Änderungen an Revit-Familien** <a href="#changes-to-revit-families" id="changes-to-revit-families"></a>
...
## Wichtige Hinweise <a href="#revit-important-notes" id="revit-important-notes"></a>

### **Unterstützung erhalten** <a href="#get-support" id="get-support"></a>

Benötigen Sie Hilfe bei FormIt und Revit? [In den Foren können Sie uns dies mitteilen](https://forums.autodesk.com/t5/formit-forum/bd-p/142?profile.language=de).

Herunterladen des alten Revit-Zusatzmoduls\
(2021 oder älter) <a href="#revit-download" id="revit-download"></a>
------------------------------------------------------------------
...
[Siehe Downloads für ältere Revit-Zusatzmodule](https://formit.autodesk.com/page/download#download-revit-add-in)
