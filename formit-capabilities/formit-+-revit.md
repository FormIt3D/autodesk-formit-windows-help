...
* Revit でレベルを選択すると、FormIt はそれらのレベルを受け取ります。選択しない場合、FormIt は Revit の表示レベルをすべて受け取ります。
...
* 詳細については、[Revit のドキュメントを参照してください。](https://help.autodesk.com/view/RVT/2023/JPN/?guid=GUID-A5F4B6C1-94CD-4433-A4E2-6B39B4BA8E6D)
...
## 重要<a href="#revit-important-notes" id="revit-important-notes"></a>

### **サポートを依頼する**<a href="#get-support" id="get-support"></a>

FormIt + Revit に関するヘルプが必要な場合は、[フォーラム](https://forums.autodesk.com/t5/formit-forum/bd-p/142?profile.language=ja)でお知らせください。
...
[旧バージョンの Revit アドインのダウンロードはこちら](https://formit.autodesk.com/page/download#download-revit-add-in)
