...
* 레이어 팔레트에서 새로운 _**Revit으로 보내기열**_ 을 사용하여 FormIt 스케치가 Revit에서 링크될 때 Revit으로 전송되는 레이어를 제어할 수 있습니다.&#x20;
...
* _FormIt에서 편집_ 을 사용하여 Revit에서 FormIt 링크를 시작할 수 있습니다.
...
* _**Revit 미리보기 모드**_ 를 사용하면 Revit으로 보낼 형상을 선택적으로 미리 볼 수 있습니다. 레이어 팔레트 맨 아래에 있는 확인란을 사용하거나 Revit으로 보내기 버튼 옆에 있는 확인란을 사용하여 Revit 미리보기 모드를 활성화합니다.
