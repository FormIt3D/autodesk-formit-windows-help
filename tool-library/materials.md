...
Создавайте модели FormIt с использованием материалов, поддерживающих отражение, глянец, карты выдавливания и нормалей.
...
В FormIt 2021 или более поздней версии панель «Материалы» имеет раскрывающийся список для выбора источников Библиотеки материалов: «В эскизе», «Образцы материалов» и [связанные библиотеки](https://windows.help.formit.autodesk.com/v/russian/tool-library/materials#privyazka-bibliotek-materialov).
...
После [привязки библиотек материалов](https://windows.help.formit.autodesk.com/v/russian/tool-library/materials#privyazka-bibliotek-materialov) отображаются другие папки.

### Создание, удаление, инструмент «пипетка»

![](../.gitbook/assets/materials\_add.PNG) **Создание материала** путем настройки его цвета, текстуры, карты выдавливания или нормалей, карты выреза, прозрачности и параметров отражения/глянца.

![](<../.gitbook/assets/materials\_delete (1).PNG>) **Удаление** выбранных материалов.
...
* **Карты изображений**
   ...
   * Щелкните значок «Удалить», чтобы удалить карту из этого материала.
      * **Текстура из файла изображения**
         * JPG или PNG
      * **Карта выдавливания или нормали из файла изображения**
         * Рекомендуется JPG
         * Оптимально подходит для добавления эффектов глубины к материалам.
         * Для создания карт выдавливания или нормалей с заданной текстурой можно использовать бесплатное программное обеспечение, например ShaderMap.
